...
```shell
git clone git@github.com:Srivardhan04/llama.cpp.git
cd llama.cpp
...
Run the server:
```shell
# Assuming one has the nvidia-container-toolkit (https://github.com/Srivardhan04/nvidia-container-toolkit) properly installed on Linux.
...
## References
- [Docker With CUDA](https://github.com/Srivardhan04/llama.cpp/blob/master/docs/docker.md#docker-with-cuda)
- [LLaMA.cpp HTTP Server](https://github.com/Srivardhan04/llama.cpp/tree/master/tools/server)
